...
public class CSSStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new nl.dslmeinte.xtext.css.CSSRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.dslmeinte.nl/xtext/css")) {
		EPackage.Registry.INSTANCE.put("http://www.dslmeinte.nl/xtext/css", nl.dslmeinte.xtext.css.css.CssPackage.eINSTANCE);
	}
